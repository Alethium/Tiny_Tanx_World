...
@onready var l_1: Sprite2D = $Menu_container/Builder_ui/Button/L1_Selection
...
@onready var r_1: Sprite2D = $Menu_container/Builder_ui/R1_selection/R1_Selection
